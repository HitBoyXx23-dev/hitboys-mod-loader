...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        Asm.init();
        HitBoyPlatform.registerBytecodeTransformer("meteor-asm", Asm.INSTANCE::transform);
        isOriginsPresent = HitBoyPlatform.getMod("origins").isPresent();
        isSodiumPresent = HitBoyPlatform.getMod("sodium").isPresent();
        isLithiumPresent = HitBoyPlatform.getMod("lithium").isPresent();
        isIrisPresent = HitBoyPlatform.getMod("iris").isPresent();
