...
@NativeMod(name = "Meteor Client - HitBoy's Mod Loader Edition", version = "1.21.11-86")
public class MeteorClient implements HitBoyClientInitializer {
    ...
    public static final File FOLDER = HitBoyPlatform.getGameDirectory().resolve(MOD_ID).toFile();
    public static final Logger LOG;

    static {
        NAME = "Meteor Client";
        LOG = LoggerFactory.getLogger(NAME);
        VERSION = new Version("1.21.11");
        BUILD_NUMBER = "86";
    }
    ...
    public void onInitializeClient() {
        ...
        if (HitBoyPlatform.isDevelopmentEnvironment()) {
